...
int test_cam()
{
    ...
    ncnn::Net detector;  
    detector.load_param("/home/pi/Downloads/Yolo-Fastest_RaspberryPi/models/yolo-fastest.param");
    detector.load_model("/home/pi/Downloads/Yolo-Fastest_RaspberryPi/models/yolo-fastest.bin");
