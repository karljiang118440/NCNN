...
int test_cam()
{
    ...
    ncnn::Net detector;  
    // detector.load_param("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/yoloface-500k.param");
    // detector.load_model("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/yoloface-500k.bin");

    detector.load_param("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/yoloface-50k-opt.param");
    detector.load_model("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/yoloface-50k-opt.bin");

    // int detector_size_width  = 320;
    // int detector_size_height = 256;


    int detector_size_width  = 56;
    int detector_size_height = 56;


    //定义106关键点预测器
    ncnn::Net landmark;  
    landmark.load_param("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/landmark106.param");
    landmark.load_model("/media/jcq/Soft/NCNN/workspace/Yoloface_RaspberryPi/models/yolo/landmark106.bin");
