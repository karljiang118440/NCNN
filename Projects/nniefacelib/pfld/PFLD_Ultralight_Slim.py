...
class PFLDInference(nn.Module):
    def __init__(self):
        ...
        self.conv3_1 = GhostBottleneck(int(64 * 1), int(128 * 1), int(64 * 1), stride=2)

        self.block3_2 = GhostBottleneck(int(64 * 1), int(128 * 1), int(64 * 1), stride=1)
        self.block3_3 = GhostBottleneck(int(64 * 1), int(128 * 1), int(64 * 1), stride=1)
        self.block3_4 = GhostBottleneck(int(64 * 1), int(128 * 1), int(64 * 1), stride=1)
        self.block3_5 = GhostBottleneck(int(64 * 1), int(128 * 1), int(64 * 1), stride=1)

        self.conv4_1 = GhostBottleneck(int(64 * 1), int(256 * 1), int(128 * 1), stride=2)

        self.conv5_1 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)
        self.block5_2 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)
        self.block5_3 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)
        self.block5_4 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)
        self.block5_5 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)
        self.block5_6 = GhostBottleneck(int(128 * 1), int(512 * 1), int(128 * 1), stride=1)


        self.conv6_1 = GhostBottleneck(int(128 * 1), int(256 * 1), int(16 * 1), stride=1)
        ...
        self.conv7 = conv_bn(int(16 * 1), int(32 * 1), 3, 2)
        self.conv8 = nn.Conv2d(int(32 * 1), int(128 * 1), 7, 1, 0)

        # self.avg_pool1 = AvgPool2d(112 // 2)
        # self.avg_pool2 = AvgPool2d(112 // 4)
        # self.avg_pool3 = AvgPool2d(112 // 8)
        # self.avg_pool4 = AvgPool2d(112 // 16)
